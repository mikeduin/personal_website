...
function alaService ($http) {
  return {
    ...
    getChampions20: function() {
      return $http.get('javascripts/alapodiums/champions20.json')
      .then(function(results){
        return results.data;
      })
    },
    getChampions21: function() {
      return $http.get('javascripts/alapodiums/champions21.json')
      .then(function(results){
        return results.data;
      })
    },
    getChampions22: function() {
      return $http.get('javascripts/alapodiums/champions22.json')
      .then(function(results){
        return results.data;
      })
    },
    getChampions23: function() {
      return $http.get('javascripts/alapodiums/champions23.json')
      .then(function(results){
        return results.data;
      })
    },
    getChampions24: function() {
      return $http.get('javascripts/alapodiums/champions24.json')
      .then(function(results){
        return results.data;
      })
    },
