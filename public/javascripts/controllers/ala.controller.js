...
function AlaController ($scope, $anchorScroll, $location, alaService, $state, $stateParams) {
  ...
  $scope.vm.confidenceData = {
    ...
    'series':[
      {
        "values": [675, 810, 780, 930, 1120, 890, 1840, 2430],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.ncaaPickEmData = {
    ...
    'series':[
      {
        "values": [550, 1170, 1050, 1080, 1080, 1090, 1150, 1550, 1650],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.bowlPickEmData = {
    ...
    'scaleX':{
      'values': [2009, 2010, 2012, 2013, 2014, 2015, 2016],
      'offset-y': 4,
    },
    'scaleY':{
      'format': '$%v'
    ...
    'series':[
      {
        "values": [100, 110, 165, 320, 600, 920, 800],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
