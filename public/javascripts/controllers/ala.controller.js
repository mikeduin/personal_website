...
function AlaController ($scope, $anchorScroll, $location, alaService, authService, $state, $stateParams) {
  ...
  $scope.vm.madnessData = {
    ...
    'scaleX':{
      'values': [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018],
      'offset-y': 4,
    },
    'scaleY':{
      'format': '$%v'
    ...
    'series':[
      {
        "values": [660, 1134, 1510, 1680, 2110, 3540, 5423, 6511, 6675, 8787, 9792],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.confidenceData = {
    ...
    'series':[
      {
        "values": [675, 810, 780, 930, 1120, 890, 1840, 2430, 1690, 1790],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.ncaaPickEmData = {
    ...
    'series':[
      {
        "values": [550, 1170, 1050, 1080, 1080, 1090, 1150, 1550, 1650, 1970, 1760],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.btbData = {
    ...
    'series':[
      {
        "values": [1620, 3600, 5100, 4890, 5580],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.survivorData = {
    ...
    'series':[
      {
        "values": [1155, 1870, 1870, 2750, 3905, 4180, 4620, 4950, 3880, 3800, 4275],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.bowlPickEmData = {
    ...
    'scaleX':{
      'values': [2009, 2010, 2012, 2013, 2014, 2015, 2016, 2017, 2018],
      'offset-y': 4,
    },
    'scaleY':{
      'format': '$%v'
    ...
    'series':[
      {
        "values": [100, 110, 165, 320, 600, 920, 800, 920, 1360],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
