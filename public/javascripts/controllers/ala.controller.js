...
function AlaController ($scope, $anchorScroll, $location, alaService, authService, $state, $stateParams) {
  ...
  $scope.vm.madnessData = {
    ...
    'scaleX':{
      'values': [2008, 2009, 2010, 2011, 2012, 2013, 2014, 2015, 2016, 2017, 2018, 2019, 2021],
      'offset-y': 4,
    },
    'scaleY':{
      'format': '$%v'
    ...
    'series':[
      {
        "values": [660, 1134, 1510, 1680, 2110, 3540, 5423, 6511, 6675, 8787, 9792, 12200, 11280],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.ncaaPickEmData = {
    ...
    'series':[
      {
        "values": [550, 1170, 1050, 1080, 1080, 1090, 1150, 1550, 1650, 1970, 1760, 2224, 1110, 1870],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.btbData = {
    ...
    'scaleX':{
      'values': [2014, 2015, 2016, 2017, 2018, 2019, 2020, 2021],
      'offset-y': 4,
    },
    'scaleY':{
      'format': '$%v'
    ...
    'series':[
      {
        "values": [1620, 3600, 5100, 4890, 5580, 6634, 8330, 8921],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
  ...
  $scope.vm.calcuttaData = {
    ...
    'scaleX':{
      'labels': ["'18 March Madness", "'18 Masters", "'18 NBA Playoffs", "'18 World Cup", "'18 NCAA Football", "'18 NFL", "'19 March Madness [SEL]", "'19 March Madness [PUB]", "'19 Masters", "'19 US Open", "'19 NFL", "'20 Masters", "'21 March Madness", "'21 Masters", "'21 PGA Champ", "'21 US Open", "'21 British Open", "'21 NFL"],
      'offset-y': 4,
      'max-items': 75,
      'item': {
        angle: 20
    ...
    'series':[
      {
        "values": [3243, 2735, 2228, 2958, 2867, 1930, 3840, 4323, 1753, 1557, 1877, 2493, 6348, 3736, 3637, 3326, 3675, 4584],
        "type": 'line',
        "line-color": "#DC5623",
        'legend-text': 'Prize $',
        "animation": {
