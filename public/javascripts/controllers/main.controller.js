...
function MainController ($scope, $state, $sce, $anchorScroll, $location){
  ...
  $scope.italyPopover = $sce.trustAsHtml('[Truth be told: having fulfilled all my electives at USC prior to my semester in Florence -- and with Gonzaga not offering any accounting classes as part of their Italian curriculum -- there was no way for me to earn credit for the classes I was taking while abroad. Thus, my education while in Europe included courses of study such as: European Soccer 101, Principles of Rural Vespa Navigation, and Intro to Italian Nightlife.]');
