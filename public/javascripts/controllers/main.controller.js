...
function MainController ($scope, $state, $sce, $anchorScroll, $location){
  ...
  $scope.italyPopover = $sce.trustAsHtml('[Truth be told: having fulfilled all my electives at USC prior to my semester in Florence -- and with Gonzaga not offering any accounting classes as part of their Italian curriculum -- there was no way for me to take classes there that USC would give me credit for. Thus, the studying I did in Italy included courses of study such as: European Soccer 101, How to Spend a Weekend in a Foreign Country ]');
